...
const (
	...
	Greeter_GetHello_FullMethodName = "/helloworld.Greeter/GetHello"
)
...
func (c *greeterClient) GetHello(ctx context.Context, in *GetHelloRequest, opts ...grpc.CallOption) (*GetHelloReply, error) {
	...
	err := c.cc.Invoke(ctx, Greeter_GetHello_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGreeterServer) GetHello(context.Context, *GetHelloRequest) (*GetHelloReply, error) {
